      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1">
        <Card>
          ...
          <CardContent className="flex justify-between">
            ...
            <Waypoints className="h-9 w-9" style={{ color: "#34d399" }} />
            {/* <svg
        ...
        <Card>
          ...
          <CardContent className="flex justify-between">
            ...
            <BookDashed className="h-9 w-9" style={{ color: "#60a5fa" }} />
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent className="flex justify-between">
            ...
            <Loader className="h-9 w-9" style={{ color: "#808181" }} />
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent className="flex justify-between">
            ...
            <Hourglass className="h-9 w-9" style={{ color: "#4683b5" }} />
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent className="flex justify-between">
            ...
            <Presentation className="h-9 w-9" style={{ color: "#018180" }} />
          </CardContent>
        </Card>
      </div>
      {/* Adjust here */}
      <div className="mb-4 grid gap-4 md:grid-cols-12 lg:grid-cols-2">
        ...
        <Card className="col-span-5 md:col-span-5 lg:col-span-1">
          ...
          <CardContent className={"px-4 md:px-4 lg:px-4 col-span-5"}>
            <ScrollArea>
              <Tabs defaultValue="productive" className="w-full">
