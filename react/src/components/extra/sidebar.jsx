...
export function Sidebar({ className, open, setOpen }) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      notif: waitingForApprovalTeamsCount,
    },
    {
      name: "Attendance",
      href: "/attendance",
    ...
    },
    {
      ...
      notif: waitingForApprovalCount, // Number of waiting for approval
    },
    {
      name: "Categorization",
      href: "/categorization",
